...
ImageButton btnPickImage = findViewById(R.id.btnPickImage);
        ...
        btnNavigate.setOnClickListener(view -> {
            ...
            if (enrollmentNo.trim().isEmpty() || !isImageSelected ) {
                Toast.makeText(MainActivity.this, "Please Enter All Details and upload image", Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                loadingDialogUtil = new LoadingDialogUtil(MainActivity.this);
        ...
        studentApiService.addStudent(student, new Callback<Student>() {
            ...
            public void onResponse(@NonNull Call<Student> call, @NonNull Response<Student> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Intent intent = new Intent(MainActivity.this, idViewActivity.class);
